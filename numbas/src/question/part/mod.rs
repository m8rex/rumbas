...
pub struct QuestionPartSharedData {
    ...
    #[serde(flatten)]
    pub adaptive_marking: AdaptiveMarking,
    #[serde(flatten)]
    pub custom_marking: CustomMarking,
    //scripts TODO
...
pub struct AdaptiveMarking {
    #[serde(rename = "variableReplacements")]
    #[serde(default)]
    pub variable_replacements: Vec<VariableReplacement>,
...
impl std::default::Default for AdaptiveMarking {
    fn default() -> Self {
        serde_json::from_str("{}").expect("AdaptiveMarking to be parseable from empty object")
    }
}
...
impl std::default::Default for CustomMarking {
    fn default() -> Self {
        serde_json::from_str("{}").expect("CustomMarking to be parseable from empty object")
    }
}
