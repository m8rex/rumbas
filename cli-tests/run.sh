...
import_and_compile(){
  FILE=$1
  EXAM_NAME=$2
  rumbas -vvvv import "numbas_exams/"$FILE".exam"
...
import_and_compile_q(){
  FILE=$1
  QUESTION_NAME=$2
  rumbas -vvvv import -q "numbas_questions/"$FILE".exam"
...
import_and_compile exam-148976-exam-matrices-eerste-versie "exam matrices eerste versie"
import_and_compile exam-149062-vectoren-vragen-inspiratie "vectoren vragen inspiratie"
import_and_compile exam-149063-trig-geometry "trig + geometry"
